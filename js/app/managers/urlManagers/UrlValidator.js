(function(global) {
    ...
    MyApp.UrlValidator = class UrlValidator {
        ...
        isValid(urlQueryParamRepo) {
            ...
            var rlat = urlQueryParamRepo.getQueryValueBy('rlat');
            var rlng = urlQueryParamRepo.getQueryValueBy('rlng');
            if (this._isValidLatLngOptional(rlat, rlng) === false) {
                return false;
            }
            var rdclat = urlQueryParamRepo.getQueryValueBy('rdclat');
            var rdclng = urlQueryParamRepo.getQueryValueBy('rdclng');
            if (this._isValidLatLngOptional(rdclat, rdclng) === false) {
                return false;
            }
